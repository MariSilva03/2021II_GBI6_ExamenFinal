...
```{r wd}
setwd("C:\\Users\\Dell\\Desktop\\EXAMENRstudio\\2021II_GBI6_ExamenFinal\\results")
getwd()
```
...
descr(cancer_mama) %>% tab_df(title = "Estadistica descriptiva del cancer de MAMA y su nivel de expresion de los diferentes genes",
                              file = "C:\\Users\\Dell\\Desktop\\EXAMENRstudio\\2021II_GBI6_ExamenFinal\\results\\mRNA_expr_summary.doc") 
...
```{tex}
Se observa los niveles de expresion del cancer de mama en los genes de la tabla
...
ggsave("C:\\Users\\Dell\\Desktop\\EXAMENRstudio\\2021II_GBI6_ExamenFinal\\results\\boxplot3.png", width = 6, height = 8, dpi = 300)
...
ggsave("C:\\Users\\Dell\\Desktop\\EXAMENRstudio\\2021II_GBI6_ExamenFinal\\results\\regresion11.pdf", width = 6, height = 8, dpi = 300)
...
```{tex}
# Esciba aquí su interpretacion
En la regresion lineal se observa que tan proximos estan los dos genes estudiados, por ello se ve los puntos de aproximacion. 
